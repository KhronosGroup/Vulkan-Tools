...
static const char *VkColorSpaceKHRString(VkColorSpaceKHR value) {
    switch (value) {
        case VkColorSpaceKHR(0): return "COLOR_SPACE_SRGB_NONLINEAR_KHR";
        case VkColorSpaceKHR(1000104001): return "COLOR_SPACE_DISPLAY_P3_NONLINEAR_EXT";
        case VkColorSpaceKHR(1000104002): return "COLOR_SPACE_EXTENDED_SRGB_LINEAR_EXT";
        case VkColorSpaceKHR(1000104003): return "COLOR_SPACE_DISPLAY_P3_LINEAR_EXT";
        case VkColorSpaceKHR(1000104004): return "COLOR_SPACE_DCI_P3_NONLINEAR_EXT";
        case VkColorSpaceKHR(1000104005): return "COLOR_SPACE_BT709_LINEAR_EXT";
        case VkColorSpaceKHR(1000104006): return "COLOR_SPACE_BT709_NONLINEAR_EXT";
        case VkColorSpaceKHR(1000104007): return "COLOR_SPACE_BT2020_LINEAR_EXT";
        case VkColorSpaceKHR(1000104008): return "COLOR_SPACE_HDR10_ST2084_EXT";
        case VkColorSpaceKHR(1000104009): return "COLOR_SPACE_DOLBYVISION_EXT";
        case VkColorSpaceKHR(1000104010): return "COLOR_SPACE_HDR10_HLG_EXT";
        case VkColorSpaceKHR(1000104011): return "COLOR_SPACE_ADOBERGB_LINEAR_EXT";
        case VkColorSpaceKHR(1000104012): return "COLOR_SPACE_ADOBERGB_NONLINEAR_EXT";
        case VkColorSpaceKHR(1000104013): return "COLOR_SPACE_PASS_THROUGH_EXT";
        case VkColorSpaceKHR(1000104014): return "COLOR_SPACE_EXTENDED_SRGB_NONLINEAR_EXT";
        case VkColorSpaceKHR(1000213000): return "COLOR_SPACE_DISPLAY_NATIVE_AMD";
...
static const char *VkDriverIdString(VkDriverId value) {
    switch (value) {
        case VkDriverId(1): return "DRIVER_ID_AMD_PROPRIETARY";
        case VkDriverId(2): return "DRIVER_ID_AMD_OPEN_SOURCE";
        case VkDriverId(3): return "DRIVER_ID_MESA_RADV";
        case VkDriverId(4): return "DRIVER_ID_NVIDIA_PROPRIETARY";
        case VkDriverId(5): return "DRIVER_ID_INTEL_PROPRIETARY_WINDOWS";
        case VkDriverId(6): return "DRIVER_ID_INTEL_OPEN_SOURCE_MESA";
        case VkDriverId(7): return "DRIVER_ID_IMAGINATION_PROPRIETARY";
        case VkDriverId(8): return "DRIVER_ID_QUALCOMM_PROPRIETARY";
        case VkDriverId(9): return "DRIVER_ID_ARM_PROPRIETARY";
        case VkDriverId(10): return "DRIVER_ID_GOOGLE_SWIFTSHADER";
        case VkDriverId(11): return "DRIVER_ID_GGP_PROPRIETARY";
        case VkDriverId(12): return "DRIVER_ID_BROADCOM_PROPRIETARY";
        case VkDriverId(13): return "DRIVER_ID_MESA_LLVMPIPE";
        case VkDriverId(14): return "DRIVER_ID_MOLTENVK";
        case VkDriverId(15): return "DRIVER_ID_COREAVI_PROPRIETARY";
        case VkDriverId(16): return "DRIVER_ID_JUICE_PROPRIETARY";
...
static const char *VkFormatString(VkFormat value) {
    switch (value) {
        case VkFormat(0): return "FORMAT_UNDEFINED";
        case VkFormat(1): return "FORMAT_R4G4_UNORM_PACK8";
        case VkFormat(2): return "FORMAT_R4G4B4A4_UNORM_PACK16";
        case VkFormat(3): return "FORMAT_B4G4R4A4_UNORM_PACK16";
        case VkFormat(4): return "FORMAT_R5G6B5_UNORM_PACK16";
        case VkFormat(5): return "FORMAT_B5G6R5_UNORM_PACK16";
        case VkFormat(6): return "FORMAT_R5G5B5A1_UNORM_PACK16";
        case VkFormat(7): return "FORMAT_B5G5R5A1_UNORM_PACK16";
        case VkFormat(8): return "FORMAT_A1R5G5B5_UNORM_PACK16";
        case VkFormat(9): return "FORMAT_R8_UNORM";
        case VkFormat(10): return "FORMAT_R8_SNORM";
        case VkFormat(11): return "FORMAT_R8_USCALED";
        case VkFormat(12): return "FORMAT_R8_SSCALED";
        case VkFormat(13): return "FORMAT_R8_UINT";
        case VkFormat(14): return "FORMAT_R8_SINT";
        case VkFormat(15): return "FORMAT_R8_SRGB";
        case VkFormat(16): return "FORMAT_R8G8_UNORM";
        case VkFormat(17): return "FORMAT_R8G8_SNORM";
        case VkFormat(18): return "FORMAT_R8G8_USCALED";
        case VkFormat(19): return "FORMAT_R8G8_SSCALED";
        case VkFormat(20): return "FORMAT_R8G8_UINT";
        case VkFormat(21): return "FORMAT_R8G8_SINT";
        case VkFormat(22): return "FORMAT_R8G8_SRGB";
        case VkFormat(23): return "FORMAT_R8G8B8_UNORM";
        case VkFormat(24): return "FORMAT_R8G8B8_SNORM";
        case VkFormat(25): return "FORMAT_R8G8B8_USCALED";
        case VkFormat(26): return "FORMAT_R8G8B8_SSCALED";
        case VkFormat(27): return "FORMAT_R8G8B8_UINT";
        case VkFormat(28): return "FORMAT_R8G8B8_SINT";
        case VkFormat(29): return "FORMAT_R8G8B8_SRGB";
        case VkFormat(30): return "FORMAT_B8G8R8_UNORM";
        case VkFormat(31): return "FORMAT_B8G8R8_SNORM";
        case VkFormat(32): return "FORMAT_B8G8R8_USCALED";
        case VkFormat(33): return "FORMAT_B8G8R8_SSCALED";
        case VkFormat(34): return "FORMAT_B8G8R8_UINT";
        case VkFormat(35): return "FORMAT_B8G8R8_SINT";
        case VkFormat(36): return "FORMAT_B8G8R8_SRGB";
        case VkFormat(37): return "FORMAT_R8G8B8A8_UNORM";
        case VkFormat(38): return "FORMAT_R8G8B8A8_SNORM";
        case VkFormat(39): return "FORMAT_R8G8B8A8_USCALED";
        case VkFormat(40): return "FORMAT_R8G8B8A8_SSCALED";
        case VkFormat(41): return "FORMAT_R8G8B8A8_UINT";
        case VkFormat(42): return "FORMAT_R8G8B8A8_SINT";
        case VkFormat(43): return "FORMAT_R8G8B8A8_SRGB";
        case VkFormat(44): return "FORMAT_B8G8R8A8_UNORM";
        case VkFormat(45): return "FORMAT_B8G8R8A8_SNORM";
        case VkFormat(46): return "FORMAT_B8G8R8A8_USCALED";
        case VkFormat(47): return "FORMAT_B8G8R8A8_SSCALED";
        case VkFormat(48): return "FORMAT_B8G8R8A8_UINT";
        case VkFormat(49): return "FORMAT_B8G8R8A8_SINT";
        case VkFormat(50): return "FORMAT_B8G8R8A8_SRGB";
        case VkFormat(51): return "FORMAT_A8B8G8R8_UNORM_PACK32";
        case VkFormat(52): return "FORMAT_A8B8G8R8_SNORM_PACK32";
        case VkFormat(53): return "FORMAT_A8B8G8R8_USCALED_PACK32";
        case VkFormat(54): return "FORMAT_A8B8G8R8_SSCALED_PACK32";
        case VkFormat(55): return "FORMAT_A8B8G8R8_UINT_PACK32";
        case VkFormat(56): return "FORMAT_A8B8G8R8_SINT_PACK32";
        case VkFormat(57): return "FORMAT_A8B8G8R8_SRGB_PACK32";
        case VkFormat(58): return "FORMAT_A2R10G10B10_UNORM_PACK32";
        case VkFormat(59): return "FORMAT_A2R10G10B10_SNORM_PACK32";
        case VkFormat(60): return "FORMAT_A2R10G10B10_USCALED_PACK32";
        case VkFormat(61): return "FORMAT_A2R10G10B10_SSCALED_PACK32";
        case VkFormat(62): return "FORMAT_A2R10G10B10_UINT_PACK32";
        case VkFormat(63): return "FORMAT_A2R10G10B10_SINT_PACK32";
        case VkFormat(64): return "FORMAT_A2B10G10R10_UNORM_PACK32";
        case VkFormat(65): return "FORMAT_A2B10G10R10_SNORM_PACK32";
        case VkFormat(66): return "FORMAT_A2B10G10R10_USCALED_PACK32";
        case VkFormat(67): return "FORMAT_A2B10G10R10_SSCALED_PACK32";
        case VkFormat(68): return "FORMAT_A2B10G10R10_UINT_PACK32";
        case VkFormat(69): return "FORMAT_A2B10G10R10_SINT_PACK32";
        case VkFormat(70): return "FORMAT_R16_UNORM";
        case VkFormat(71): return "FORMAT_R16_SNORM";
        case VkFormat(72): return "FORMAT_R16_USCALED";
        case VkFormat(73): return "FORMAT_R16_SSCALED";
        case VkFormat(74): return "FORMAT_R16_UINT";
        case VkFormat(75): return "FORMAT_R16_SINT";
        case VkFormat(76): return "FORMAT_R16_SFLOAT";
        case VkFormat(77): return "FORMAT_R16G16_UNORM";
        case VkFormat(78): return "FORMAT_R16G16_SNORM";
        case VkFormat(79): return "FORMAT_R16G16_USCALED";
        case VkFormat(80): return "FORMAT_R16G16_SSCALED";
        case VkFormat(81): return "FORMAT_R16G16_UINT";
        case VkFormat(82): return "FORMAT_R16G16_SINT";
        case VkFormat(83): return "FORMAT_R16G16_SFLOAT";
        case VkFormat(84): return "FORMAT_R16G16B16_UNORM";
        case VkFormat(85): return "FORMAT_R16G16B16_SNORM";
        case VkFormat(86): return "FORMAT_R16G16B16_USCALED";
        case VkFormat(87): return "FORMAT_R16G16B16_SSCALED";
        case VkFormat(88): return "FORMAT_R16G16B16_UINT";
        case VkFormat(89): return "FORMAT_R16G16B16_SINT";
        case VkFormat(90): return "FORMAT_R16G16B16_SFLOAT";
        case VkFormat(91): return "FORMAT_R16G16B16A16_UNORM";
        case VkFormat(92): return "FORMAT_R16G16B16A16_SNORM";
        case VkFormat(93): return "FORMAT_R16G16B16A16_USCALED";
        case VkFormat(94): return "FORMAT_R16G16B16A16_SSCALED";
        case VkFormat(95): return "FORMAT_R16G16B16A16_UINT";
        case VkFormat(96): return "FORMAT_R16G16B16A16_SINT";
        case VkFormat(97): return "FORMAT_R16G16B16A16_SFLOAT";
        case VkFormat(98): return "FORMAT_R32_UINT";
        case VkFormat(99): return "FORMAT_R32_SINT";
        case VkFormat(100): return "FORMAT_R32_SFLOAT";
        case VkFormat(101): return "FORMAT_R32G32_UINT";
        case VkFormat(102): return "FORMAT_R32G32_SINT";
        case VkFormat(103): return "FORMAT_R32G32_SFLOAT";
        case VkFormat(104): return "FORMAT_R32G32B32_UINT";
        case VkFormat(105): return "FORMAT_R32G32B32_SINT";
        case VkFormat(106): return "FORMAT_R32G32B32_SFLOAT";
        case VkFormat(107): return "FORMAT_R32G32B32A32_UINT";
        case VkFormat(108): return "FORMAT_R32G32B32A32_SINT";
        case VkFormat(109): return "FORMAT_R32G32B32A32_SFLOAT";
        case VkFormat(110): return "FORMAT_R64_UINT";
        case VkFormat(111): return "FORMAT_R64_SINT";
        case VkFormat(112): return "FORMAT_R64_SFLOAT";
        case VkFormat(113): return "FORMAT_R64G64_UINT";
        case VkFormat(114): return "FORMAT_R64G64_SINT";
        case VkFormat(115): return "FORMAT_R64G64_SFLOAT";
        case VkFormat(116): return "FORMAT_R64G64B64_UINT";
        case VkFormat(117): return "FORMAT_R64G64B64_SINT";
        case VkFormat(118): return "FORMAT_R64G64B64_SFLOAT";
        case VkFormat(119): return "FORMAT_R64G64B64A64_UINT";
        case VkFormat(120): return "FORMAT_R64G64B64A64_SINT";
        case VkFormat(121): return "FORMAT_R64G64B64A64_SFLOAT";
        case VkFormat(122): return "FORMAT_B10G11R11_UFLOAT_PACK32";
        case VkFormat(123): return "FORMAT_E5B9G9R9_UFLOAT_PACK32";
        case VkFormat(124): return "FORMAT_D16_UNORM";
        case VkFormat(125): return "FORMAT_X8_D24_UNORM_PACK32";
        case VkFormat(126): return "FORMAT_D32_SFLOAT";
        case VkFormat(127): return "FORMAT_S8_UINT";
        case VkFormat(128): return "FORMAT_D16_UNORM_S8_UINT";
        case VkFormat(129): return "FORMAT_D24_UNORM_S8_UINT";
        case VkFormat(130): return "FORMAT_D32_SFLOAT_S8_UINT";
        case VkFormat(131): return "FORMAT_BC1_RGB_UNORM_BLOCK";
        case VkFormat(132): return "FORMAT_BC1_RGB_SRGB_BLOCK";
        case VkFormat(133): return "FORMAT_BC1_RGBA_UNORM_BLOCK";
        case VkFormat(134): return "FORMAT_BC1_RGBA_SRGB_BLOCK";
        case VkFormat(135): return "FORMAT_BC2_UNORM_BLOCK";
        case VkFormat(136): return "FORMAT_BC2_SRGB_BLOCK";
        case VkFormat(137): return "FORMAT_BC3_UNORM_BLOCK";
        case VkFormat(138): return "FORMAT_BC3_SRGB_BLOCK";
        case VkFormat(139): return "FORMAT_BC4_UNORM_BLOCK";
        case VkFormat(140): return "FORMAT_BC4_SNORM_BLOCK";
        case VkFormat(141): return "FORMAT_BC5_UNORM_BLOCK";
        case VkFormat(142): return "FORMAT_BC5_SNORM_BLOCK";
        case VkFormat(143): return "FORMAT_BC6H_UFLOAT_BLOCK";
        case VkFormat(144): return "FORMAT_BC6H_SFLOAT_BLOCK";
        case VkFormat(145): return "FORMAT_BC7_UNORM_BLOCK";
        case VkFormat(146): return "FORMAT_BC7_SRGB_BLOCK";
        case VkFormat(147): return "FORMAT_ETC2_R8G8B8_UNORM_BLOCK";
        case VkFormat(148): return "FORMAT_ETC2_R8G8B8_SRGB_BLOCK";
        case VkFormat(149): return "FORMAT_ETC2_R8G8B8A1_UNORM_BLOCK";
        case VkFormat(150): return "FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK";
        case VkFormat(151): return "FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK";
        case VkFormat(152): return "FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK";
        case VkFormat(153): return "FORMAT_EAC_R11_UNORM_BLOCK";
        case VkFormat(154): return "FORMAT_EAC_R11_SNORM_BLOCK";
        case VkFormat(155): return "FORMAT_EAC_R11G11_UNORM_BLOCK";
        case VkFormat(156): return "FORMAT_EAC_R11G11_SNORM_BLOCK";
        case VkFormat(157): return "FORMAT_ASTC_4x4_UNORM_BLOCK";
        case VkFormat(158): return "FORMAT_ASTC_4x4_SRGB_BLOCK";
        case VkFormat(159): return "FORMAT_ASTC_5x4_UNORM_BLOCK";
        case VkFormat(160): return "FORMAT_ASTC_5x4_SRGB_BLOCK";
        case VkFormat(161): return "FORMAT_ASTC_5x5_UNORM_BLOCK";
        case VkFormat(162): return "FORMAT_ASTC_5x5_SRGB_BLOCK";
        case VkFormat(163): return "FORMAT_ASTC_6x5_UNORM_BLOCK";
        case VkFormat(164): return "FORMAT_ASTC_6x5_SRGB_BLOCK";
        case VkFormat(165): return "FORMAT_ASTC_6x6_UNORM_BLOCK";
        case VkFormat(166): return "FORMAT_ASTC_6x6_SRGB_BLOCK";
        case VkFormat(167): return "FORMAT_ASTC_8x5_UNORM_BLOCK";
        case VkFormat(168): return "FORMAT_ASTC_8x5_SRGB_BLOCK";
        case VkFormat(169): return "FORMAT_ASTC_8x6_UNORM_BLOCK";
        case VkFormat(170): return "FORMAT_ASTC_8x6_SRGB_BLOCK";
        case VkFormat(171): return "FORMAT_ASTC_8x8_UNORM_BLOCK";
        case VkFormat(172): return "FORMAT_ASTC_8x8_SRGB_BLOCK";
        case VkFormat(173): return "FORMAT_ASTC_10x5_UNORM_BLOCK";
        case VkFormat(174): return "FORMAT_ASTC_10x5_SRGB_BLOCK";
        case VkFormat(175): return "FORMAT_ASTC_10x6_UNORM_BLOCK";
        case VkFormat(176): return "FORMAT_ASTC_10x6_SRGB_BLOCK";
        case VkFormat(177): return "FORMAT_ASTC_10x8_UNORM_BLOCK";
        case VkFormat(178): return "FORMAT_ASTC_10x8_SRGB_BLOCK";
        case VkFormat(179): return "FORMAT_ASTC_10x10_UNORM_BLOCK";
        case VkFormat(180): return "FORMAT_ASTC_10x10_SRGB_BLOCK";
        case VkFormat(181): return "FORMAT_ASTC_12x10_UNORM_BLOCK";
        case VkFormat(182): return "FORMAT_ASTC_12x10_SRGB_BLOCK";
        case VkFormat(183): return "FORMAT_ASTC_12x12_UNORM_BLOCK";
        case VkFormat(184): return "FORMAT_ASTC_12x12_SRGB_BLOCK";
        case VkFormat(1000156000): return "FORMAT_G8B8G8R8_422_UNORM";
        case VkFormat(1000156001): return "FORMAT_B8G8R8G8_422_UNORM";
        case VkFormat(1000156002): return "FORMAT_G8_B8_R8_3PLANE_420_UNORM";
        case VkFormat(1000156003): return "FORMAT_G8_B8R8_2PLANE_420_UNORM";
        case VkFormat(1000156004): return "FORMAT_G8_B8_R8_3PLANE_422_UNORM";
        case VkFormat(1000156005): return "FORMAT_G8_B8R8_2PLANE_422_UNORM";
        case VkFormat(1000156006): return "FORMAT_G8_B8_R8_3PLANE_444_UNORM";
        case VkFormat(1000156007): return "FORMAT_R10X6_UNORM_PACK16";
        case VkFormat(1000156008): return "FORMAT_R10X6G10X6_UNORM_2PACK16";
        case VkFormat(1000156009): return "FORMAT_R10X6G10X6B10X6A10X6_UNORM_4PACK16";
        case VkFormat(1000156010): return "FORMAT_G10X6B10X6G10X6R10X6_422_UNORM_4PACK16";
        case VkFormat(1000156011): return "FORMAT_B10X6G10X6R10X6G10X6_422_UNORM_4PACK16";
        case VkFormat(1000156012): return "FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16";
        case VkFormat(1000156013): return "FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16";
        case VkFormat(1000156014): return "FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16";
        case VkFormat(1000156015): return "FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16";
        case VkFormat(1000156016): return "FORMAT_G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16";
        case VkFormat(1000156017): return "FORMAT_R12X4_UNORM_PACK16";
        case VkFormat(1000156018): return "FORMAT_R12X4G12X4_UNORM_2PACK16";
        case VkFormat(1000156019): return "FORMAT_R12X4G12X4B12X4A12X4_UNORM_4PACK16";
        case VkFormat(1000156020): return "FORMAT_G12X4B12X4G12X4R12X4_422_UNORM_4PACK16";
        case VkFormat(1000156021): return "FORMAT_B12X4G12X4R12X4G12X4_422_UNORM_4PACK16";
        case VkFormat(1000156022): return "FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16";
        case VkFormat(1000156023): return "FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16";
        case VkFormat(1000156024): return "FORMAT_G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16";
        case VkFormat(1000156025): return "FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16";
        case VkFormat(1000156026): return "FORMAT_G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16";
        case VkFormat(1000156027): return "FORMAT_G16B16G16R16_422_UNORM";
        case VkFormat(1000156028): return "FORMAT_B16G16R16G16_422_UNORM";
        case VkFormat(1000156029): return "FORMAT_G16_B16_R16_3PLANE_420_UNORM";
        case VkFormat(1000156030): return "FORMAT_G16_B16R16_2PLANE_420_UNORM";
        case VkFormat(1000156031): return "FORMAT_G16_B16_R16_3PLANE_422_UNORM";
        case VkFormat(1000156032): return "FORMAT_G16_B16R16_2PLANE_422_UNORM";
        case VkFormat(1000156033): return "FORMAT_G16_B16_R16_3PLANE_444_UNORM";
        case VkFormat(1000054000): return "FORMAT_PVRTC1_2BPP_UNORM_BLOCK_IMG";
        case VkFormat(1000054001): return "FORMAT_PVRTC1_4BPP_UNORM_BLOCK_IMG";
        case VkFormat(1000054002): return "FORMAT_PVRTC2_2BPP_UNORM_BLOCK_IMG";
        case VkFormat(1000054003): return "FORMAT_PVRTC2_4BPP_UNORM_BLOCK_IMG";
        case VkFormat(1000054004): return "FORMAT_PVRTC1_2BPP_SRGB_BLOCK_IMG";
        case VkFormat(1000054005): return "FORMAT_PVRTC1_4BPP_SRGB_BLOCK_IMG";
        case VkFormat(1000054006): return "FORMAT_PVRTC2_2BPP_SRGB_BLOCK_IMG";
        case VkFormat(1000054007): return "FORMAT_PVRTC2_4BPP_SRGB_BLOCK_IMG";
        case VkFormat(1000066000): return "FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066001): return "FORMAT_ASTC_5x4_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066002): return "FORMAT_ASTC_5x5_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066003): return "FORMAT_ASTC_6x5_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066004): return "FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066005): return "FORMAT_ASTC_8x5_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066006): return "FORMAT_ASTC_8x6_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066007): return "FORMAT_ASTC_8x8_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066008): return "FORMAT_ASTC_10x5_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066009): return "FORMAT_ASTC_10x6_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066010): return "FORMAT_ASTC_10x8_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066011): return "FORMAT_ASTC_10x10_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066012): return "FORMAT_ASTC_12x10_SFLOAT_BLOCK_EXT";
        case VkFormat(1000066013): return "FORMAT_ASTC_12x12_SFLOAT_BLOCK_EXT";
        case VkFormat(1000330000): return "FORMAT_G8_B8R8_2PLANE_444_UNORM_EXT";
        case VkFormat(1000330001): return "FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT";
        case VkFormat(1000330002): return "FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT";
        case VkFormat(1000330003): return "FORMAT_G16_B16R16_2PLANE_444_UNORM_EXT";
        case VkFormat(1000340000): return "FORMAT_A4R4G4B4_UNORM_PACK16_EXT";
        case VkFormat(1000340001): return "FORMAT_A4B4G4R4_UNORM_PACK16_EXT";
...
static const char *VkImageTilingString(VkImageTiling value) {
    switch (value) {
        case VkImageTiling(0): return "IMAGE_TILING_OPTIMAL";
        case VkImageTiling(1): return "IMAGE_TILING_LINEAR";
        case VkImageTiling(1000158000): return "IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT";
...
static const char *VkPhysicalDeviceTypeString(VkPhysicalDeviceType value) {
    switch (value) {
        case VkPhysicalDeviceType(0): return "PHYSICAL_DEVICE_TYPE_OTHER";
        case VkPhysicalDeviceType(1): return "PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU";
        case VkPhysicalDeviceType(2): return "PHYSICAL_DEVICE_TYPE_DISCRETE_GPU";
        case VkPhysicalDeviceType(3): return "PHYSICAL_DEVICE_TYPE_VIRTUAL_GPU";
        case VkPhysicalDeviceType(4): return "PHYSICAL_DEVICE_TYPE_CPU";
...
static const char *VkPointClippingBehaviorString(VkPointClippingBehavior value) {
    switch (value) {
        case VkPointClippingBehavior(0): return "POINT_CLIPPING_BEHAVIOR_ALL_CLIP_PLANES";
        case VkPointClippingBehavior(1): return "POINT_CLIPPING_BEHAVIOR_USER_CLIP_PLANES_ONLY";
...
static const char *VkPresentModeKHRString(VkPresentModeKHR value) {
    switch (value) {
        case VkPresentModeKHR(0): return "PRESENT_MODE_IMMEDIATE_KHR";
        case VkPresentModeKHR(1): return "PRESENT_MODE_MAILBOX_KHR";
        case VkPresentModeKHR(2): return "PRESENT_MODE_FIFO_KHR";
        case VkPresentModeKHR(3): return "PRESENT_MODE_FIFO_RELAXED_KHR";
        case VkPresentModeKHR(1000111000): return "PRESENT_MODE_SHARED_DEMAND_REFRESH_KHR";
        case VkPresentModeKHR(1000111001): return "PRESENT_MODE_SHARED_CONTINUOUS_REFRESH_KHR";
...
static const char *VkResultString(VkResult value) {
    switch (value) {
        case VkResult(0): return "SUCCESS";
        case VkResult(1): return "NOT_READY";
        case VkResult(2): return "TIMEOUT";
        case VkResult(3): return "EVENT_SET";
        case VkResult(4): return "EVENT_RESET";
        case VkResult(5): return "INCOMPLETE";
        case VkResult(-1): return "ERROR_OUT_OF_HOST_MEMORY";
        case VkResult(-2): return "ERROR_OUT_OF_DEVICE_MEMORY";
        case VkResult(-3): return "ERROR_INITIALIZATION_FAILED";
        case VkResult(-4): return "ERROR_DEVICE_LOST";
        case VkResult(-5): return "ERROR_MEMORY_MAP_FAILED";
        case VkResult(-6): return "ERROR_LAYER_NOT_PRESENT";
        case VkResult(-7): return "ERROR_EXTENSION_NOT_PRESENT";
        case VkResult(-8): return "ERROR_FEATURE_NOT_PRESENT";
        case VkResult(-9): return "ERROR_INCOMPATIBLE_DRIVER";
        case VkResult(-10): return "ERROR_TOO_MANY_OBJECTS";
        case VkResult(-11): return "ERROR_FORMAT_NOT_SUPPORTED";
        case VkResult(-12): return "ERROR_FRAGMENTED_POOL";
        case VkResult(-13): return "ERROR_UNKNOWN";
        case VkResult(-1000069000): return "ERROR_OUT_OF_POOL_MEMORY";
        case VkResult(-1000072003): return "ERROR_INVALID_EXTERNAL_HANDLE";
        case VkResult(-1000161000): return "ERROR_FRAGMENTATION";
        case VkResult(-1000257000): return "ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS";
        case VkResult(-1000000000): return "ERROR_SURFACE_LOST_KHR";
        case VkResult(-1000000001): return "ERROR_NATIVE_WINDOW_IN_USE_KHR";
        case VkResult(1000001003): return "SUBOPTIMAL_KHR";
        case VkResult(-1000001004): return "ERROR_OUT_OF_DATE_KHR";
        case VkResult(-1000003001): return "ERROR_INCOMPATIBLE_DISPLAY_KHR";
        case VkResult(-1000011001): return "ERROR_VALIDATION_FAILED_EXT";
        case VkResult(-1000012000): return "ERROR_INVALID_SHADER_NV";
        case VkResult(-1000158000): return "ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT";
        case VkResult(-1000174001): return "ERROR_NOT_PERMITTED_EXT";
        case VkResult(-1000255000): return "ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT";
        case VkResult(1000268000): return "THREAD_IDLE_KHR";
        case VkResult(1000268001): return "THREAD_DONE_KHR";
        case VkResult(1000268002): return "OPERATION_DEFERRED_KHR";
        case VkResult(1000268003): return "OPERATION_NOT_DEFERRED_KHR";
        case VkResult(1000297000): return "PIPELINE_COMPILE_REQUIRED_EXT";
...
static const char *VkShaderFloatControlsIndependenceString(VkShaderFloatControlsIndependence value) {
    switch (value) {
        case VkShaderFloatControlsIndependence(0): return "SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY";
        case VkShaderFloatControlsIndependence(1): return "SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL";
        case VkShaderFloatControlsIndependence(2): return "SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE";
